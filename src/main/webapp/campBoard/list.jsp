    ...
    <main>
        ...
        <div id="camp-board">
            <div class="card lg:card-side bg-base-100 shadow-xl relative mb-1 h-40">
                ...
                <div class="card-body">
                <h2 class="card-title" id="camp-title">관음사야영장</h2>
         ...
         function renderCampList(
            ...
            if (list === null || list.length === 0) {
                ...
                for (let camp of list){
                    ...
                    tag+='<div class="card lg:card-side bg-base-100 shadow-xl relative mb-1 h-40">';
                    tag+='<div id="#" class="self-center pl-3" >'+ campNumber+'</div>';
                    tag+='<div class="card-body">';
                    tag+='<h2 class="card-title" id="camp-title">'+campName+'</h2>';
