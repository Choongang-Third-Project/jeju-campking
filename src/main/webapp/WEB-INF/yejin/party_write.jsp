...
<body>
  ...
  <div class="container">
    ...
    <form action="write.jsp" method="post">
      ...
      <br>
      <label for="date" id="start_date">시작날짜를 선택하세요:
        <input type="date" id="startdate" max="2025-12-31" min="2000-01-01" value="2023-05-21">
      </label>
      <label for="date" id="end_date">마감날짜를 선택하세요:
        <input type="date" id="enddate" max="2025-12-31" min="2000-01-01" value="2023-05-21">
      </label>
